...
class CustomComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        Axios.get("http://localhost:8000/bot_text?user_message=" + this.props.previousStep.message + "&current_position=" + this.props.currentPostion + "&language=" + this.props.language).then(data => {
